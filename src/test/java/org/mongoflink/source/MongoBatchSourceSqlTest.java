...
public class MongoBatchSourceSqlTest extends EmbeddedMongoTestBase {
    ...
    public void testRead() throws Exception {
        ...
        Assert.assertEquals(
                "query result not same.",
                "[+I[9990, 9990, 9990], +I[9991, 9991, 9991], +I[9992, 9992, 9992], +I[9993, 9993, 9993], +I[9994, 9994, 9994], +I[9995, 9995, 9995], +I[9996, 9996, 9996], +I[9997, 9997, 9997], +I[9998, 9998, 9998], +I[9999, 9999, 9999]]",
                result.toString());
    }
}
